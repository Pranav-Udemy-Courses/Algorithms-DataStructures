...
6. **Polynomials**
    ...
    - Representation, Creation, Evaluation and Addition using C++ Style with new concepts  [[code]](https://github.com/ShahPranav1094-Courses/Algorithms-DataStructures/blob/master/Polynomials/PolynomialC%2B%2BStyle.cpp)
